<%-- 
    Document   : consultarTipoSancion
    Created on : 5/09/2021, 09:31:38 PM
    Author     : duban
--%>
    ...
    <section class="home-section">
        <div class="container col-md-12">
          <nav class="navbar navbar-light" style="border-radius: 20px; background-color: #160E75;">
                ...
                <center><h1>Consultar Tipo Sanciones</h1>
                <a href="registrarTipoSancion.jsp" class="btn btn-info btn-block col-md-2" >Nuevo tipo de Sanción</a></center>
    <div class="container" style="margin-top: 10px;padding: 5px">
    <table id="tablax" class="table table-striped table-bordered" style="width:100%">
        <thead>
            <th>Id tipo Sanción</th>
        ...
        <tbody>
            <tr>
                <%
                     ...
                     TipoSancionVO TiSanVO = new TipoSancionVO();
                     TipoSancionDAO TiSanDAO = new TipoSancionDAO();
                     ArrayList<TipoSancionVO>listaSanciones= TiSanDAO.listar();
                     for (int i = 0; i<listaSanciones.size(); i++){
                     
                         TiSanVO = listaSanciones.get(i); 
                     
                %>
                <th><%=TiSanVO.getIdTipoSancion()%></th>
                <td><%=TiSanVO.getNombreSancion()%></td>
               
                <td><%=TiSanVO.getDescripcion()%></td>
                
                <td>
                    <form method="post" action="Sancion">
                        <input type="hidden" name="textId" value="<%=TiSanVO.getIdTipoSancion()%>">
